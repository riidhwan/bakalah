    ...
    Scaffold(
        ...
        when {
            ...
            state.chapters.isEmpty() -> EmptyScreen(
                ...
                onClickRenameChapter = actions.onClickRenameChapter,
                onClickDeleteChapter = actions.onClickDeleteChapter,
...
data class VaultMangaScreenActions(
    ...
    val onClickRenameChapter: (VaultMangaScreenModel.VaultChapterItem, String) -> Unit,
    val onClickDeleteChapter: (VaultMangaScreenModel.VaultChapterItem) -> Unit,
