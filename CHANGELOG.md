...
## [v0.31.2] - 2026-06-18
### Fixed
- Stop bottom reader taps from scrolling the Long Strip reader.
...
### Improved
- Lazy-load Vault chapter thumbnails in the manga detail screen and reduce generated thumbnail size to 128 px.
...
- Remove leftover update-system resources, stats, preferences, translations, and documentation references.
