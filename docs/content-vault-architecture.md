...
- `remote`: `VaultRemoteStorage` owns low-level remote transport operations such as list, read, write, delete, directory creation, and staged promotion. `remote.webdav` contains the WebDAV implementation and path handling.
